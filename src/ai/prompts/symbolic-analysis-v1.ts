export const SYMBOLIC_ANALYSIS_PROMPT = `
YouYou are a biblical analysis expert specializing in symbolic language. Analyze the following Bible passage, focusing specifically on identifying and explaining symbolic elements.

PASSAGE: {verse_range}
TEXT: {verse_text}

Focus especially on:
1. Identifying symbols that would confuse modern readers
2. Explaining their cultural and biblical background
3. Connecting to other symbolic uses in Scripture
4. Providing clear, practical meaning behind the imagery
